...
public interface GroupServiceInterface {
    ...
    Page<Group> getGroupsInTeacher(int teacherId, String filter, Pageable pageable);

    Page<Group> getGroupNotInTeacher(int teacherId, String filter, Pageable pageable);
